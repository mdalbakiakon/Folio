...
//   const pcSince = useRef();
//   const mobSince = useRef();
//   const pcLink = useRef();
...
//   // useEffect(() => {
//   //   const isMobile = window.innerWidth < 768;
//   //   const video = isMobile ? mobileVidRef.current : desktopVidRef.current;
  ...
  return (
    <section className="w-full h-dvh flex justify-center items-center">
      ...
      <svg width="0" height="0">
        <defs>
          <clipPath id="heroVideoMobile" clipPathUnits="objectBoundingBox">
            <path d="M 0 0.025 Q 0 0 0.025 0 L 0.625 0 Q 0.65 0 0.65 0.025 L 0.65 0.05 Q 0.65 0.075 0.675 0.075 L 0.975 0.075 Q 1 0.075 1 0.1 L 1 0.975 Q 1 1 0.975 1 L 0.475 1 Q 0.45 0.975 0.45 0.95 L 0.45 0.925 Q 0.425 0.925 0.025 0.925 Q 0 0.925 0 0.9 Q 0 0 0 0.025 Z" />
          </clipPath>
        </defs>
      </svg>
